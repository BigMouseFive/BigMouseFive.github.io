var Zepto = function() {
    ...
    function p(t) {
        return "children" in t ? N.call(t.children) : j.map(t.childNodes,
        function(t) {
    ...
    X.fragment = function(t, e, n) {
        ...
        r || (t.replace && (t = t.replace(D, "<$1></$2>")), e === w && (e = Z.test(t) && RegExp.$1), e in I || (e = "*"), a = I[e], a.innerHTML = "" + t, r = j.each(N.call(a.childNodes),
        function() {
            a.removeChild(this)
        })),
        o(n) && (i = j(r), j.each(n,
    ...
    X.init = function(t, n) {
        var r;
        if (!t) return X.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && Z.test(t)) r = X.fragment(t, RegExp.$1, n),
        t = null;
        else {
            ...
            t = null;
            else if (Z.test(t)) r = X.fragment(t.trim(), RegExp.$1, n),
            t = null;
            else {
                if (n !== w) return j(n).find(t);
                r = X.qsa(P, t)
    ...
    j.fn = {
        ...
        ready: function(t) {
            return J.test(P.readyState) && P.body ? t(j) : P.addEventListener("DOMContentLoaded",
            function() {
                t(j)
            },
            !1),
...
function(t) {
    ...
    t.ajaxJSONP = function(e, n) {
        ...
        function(o, c) {
            clearTimeout(i),
            t(l).off().remove(),
            "error" != o.type && r ? a(r[0], p, e, n) : s(null, c || "error", p, e, n),
            window[u] = f,
    ...
    t.ajax = function(e) {
        ...
        r(i),
        i.crossDomain || (n = y.createElement("a"), n.href = i.url, n.href = n.href, i.crossDomain = S.protocol + "//" + S.host != n.protocol + "//" + n.host),
        ...
        if (c && c.promise(j), i.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", x || "*/*"), (x = i.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(x)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && w("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers) for (v in i.headers) w(v, i.headers[v]);
...
function(t, e, n) {
    ...
    t(document).keydown(function(e) {
        ...
        t("#sidebar").hasClass("slide") && ("s" === e.key ? (t("#fade").trigger("click"), t("#search").trigger("click")) : t("#sidebar ul").find("[key-trigger='" + e.key + "']").trigger("click")),
        t(".search-form").hasClass("active") && "Escape" === e.key && t(".icon-remove-sign").trigger("click")
    }),
